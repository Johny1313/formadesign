...
## Deploy verification — v0.9.7.5.45

After `npm install` and `npm run deploy`, verify:

- `/api/health` returns `version: 0.9.7.5.45`.
- `/design/` shows `0.9.7.5.45` in the top bar.
- responses under `/design/` include `X-Forma-Version: 0.9.7.5.45` and `Cache-Control: no-store`.
...
## Chart responsive resize — v0.9.7.5.45
...
## v0.9.7.5.45 — Layout, palette themes, fill/stroke and export chooser
...
## Shared library + Projects — v0.9.7.5.45
...
## Clipboard e agrupamento — v0.9.7.5.45
...
## Rich text + alinhamento — v0.9.7.5.45
...
## Clipboard + planilha de colagem — v0.9.7.5.45
...
## Planilha — cabeçalho obrigatório na primeira linha (v0.9.7.5.45)
...
## Video fidelity lock — v0.9.7.5.45
...
## Board video fidelity — v0.9.7.5.45
...
## Hub editorial de imagens — atualização escalonada 0.9.7.5.41 → 0.9.7.5.45
...
### 0.9.7.5.45 — Fluxo final factual → banco → IA
