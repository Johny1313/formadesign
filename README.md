...
## Deploy verification — v0.9.7.5.36

After `npm install` and `npm run deploy`, verify:

- `/api/health` returns `version: 0.9.7.5.36`.
- `/design/` shows `0.9.7.5.36` in the top bar.
- responses under `/design/` include `X-Forma-Version: 0.9.7.5.36` and `Cache-Control: no-store`.
...
## Chart responsive resize — v0.9.7.5.36
...
## v0.9.7.5.36 — Layout, palette themes, fill/stroke and export chooser
...
## Shared library + Projects — v0.9.7.5.36
...
## Clipboard e agrupamento — v0.9.7.5.36
...
## Rich text + alinhamento — v0.9.7.5.36
...
## Clipboard + planilha de colagem — v0.9.7.5.36
...
## Planilha — cabeçalho obrigatório na primeira linha (v0.9.7.5.36)
...
## Video fidelity lock — v0.9.7.5.36
...
## Board video fidelity — v0.9.7.5.36
