...
## Deploy verification — v0.9.7.5.48

After `npm install` and `npm run deploy`, verify:

- `/api/health` returns `version: 0.9.7.5.48`.
- `/design/` shows `0.9.7.5.48` in the top bar.
- responses under `/design/` include `X-Forma-Version: 0.9.7.5.48` and `Cache-Control: no-store`.
...
## Chart responsive resize — v0.9.7.5.48
...
## v0.9.7.5.48 — Layout, palette themes, fill/stroke and export chooser
...
## Shared library + Projects — v0.9.7.5.48
...
## Clipboard e agrupamento — v0.9.7.5.48
...
## Rich text + alinhamento — v0.9.7.5.48
...
## Clipboard + planilha de colagem — v0.9.7.5.48
...
## Planilha — cabeçalho obrigatório na primeira linha (v0.9.7.5.48)
...
## Video fidelity lock — v0.9.7.5.48
...
## Board video fidelity — v0.9.7.5.48
...
## Hub editorial de imagens — atualização escalonada 0.9.7.5.41 → 0.9.7.5.48
...
### 0.9.7.5.48 — Fluxo final factual → banco → IA
...
## Máscara por camada + Caneta — v0.9.7.5.48
