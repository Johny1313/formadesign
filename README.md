...
## Deploy verification — v0.9.7.5.39

After `npm install` and `npm run deploy`, verify:

- `/api/health` returns `version: 0.9.7.5.39`.
- `/design/` shows `0.9.7.5.39` in the top bar.
- responses under `/design/` include `X-Forma-Version: 0.9.7.5.39` and `Cache-Control: no-store`.
...
## Chart responsive resize — v0.9.7.5.39
...
## v0.9.7.5.39 — Layout, palette themes, fill/stroke and export chooser
...
## Shared library + Projects — v0.9.7.5.39
...
## Clipboard e agrupamento — v0.9.7.5.39
...
## Rich text + alinhamento — v0.9.7.5.39
...
## Clipboard + planilha de colagem — v0.9.7.5.39
...
## Planilha — cabeçalho obrigatório na primeira linha (v0.9.7.5.39)
...
## Video fidelity lock — v0.9.7.5.39
...
## Board video fidelity — v0.9.7.5.39
