...
## Deploy verification — v0.9.7.5.30

After `npm install` and `npm run deploy`, verify:

- `/api/health` returns `version: 0.9.7.5.30`.
- `/design/` shows `0.9.7.5.30` in the top bar.
- responses under `/design/` include `X-Forma-Version: 0.9.7.5.30` and `Cache-Control: no-store`.
...
## Chart responsive resize — v0.9.7.5.30
...
## v0.9.7.5.30 — Layout, palette themes, fill/stroke and export chooser
...
## Shared library + Projects — v0.9.7.5.30
...
## Clipboard e agrupamento — v0.9.7.5.30
...
## Rich text + alinhamento — v0.9.7.5.30
...
## Clipboard + planilha de colagem — v0.9.7.5.30
...
## Planilha — cabeçalho obrigatório na primeira linha (v0.9.7.5.30)
