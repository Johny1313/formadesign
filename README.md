...
## Deploy verification — v0.9.7.5.22

After `npm install` and `npm run deploy`, verify:

- `/api/health` returns `version: 0.9.7.5.22`.
- `/design/` shows `0.9.7.5.22` in the top bar.
- responses under `/design/` include `X-Forma-Version: 0.9.7.5.22` and `Cache-Control: no-store`.
...
## Chart responsive resize — v0.9.7.5.22
