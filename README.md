...
## Deploy verification — v0.9.7.5.37

After `npm install` and `npm run deploy`, verify:

- `/api/health` returns `version: 0.9.7.5.37`.
- `/design/` shows `0.9.7.5.37` in the top bar.
- responses under `/design/` include `X-Forma-Version: 0.9.7.5.37` and `Cache-Control: no-store`.
...
## Chart responsive resize — v0.9.7.5.37
...
## v0.9.7.5.37 — Layout, palette themes, fill/stroke and export chooser
...
## Shared library + Projects — v0.9.7.5.37
...
## Clipboard e agrupamento — v0.9.7.5.37
...
## Rich text + alinhamento — v0.9.7.5.37
...
## Clipboard + planilha de colagem — v0.9.7.5.37
...
## Planilha — cabeçalho obrigatório na primeira linha (v0.9.7.5.37)
...
## Video fidelity lock — v0.9.7.5.37
...
## Board video fidelity — v0.9.7.5.37
