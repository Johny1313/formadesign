...
## Deploy verification — v0.9.7.5.38

After `npm install` and `npm run deploy`, verify:

- `/api/health` returns `version: 0.9.7.5.38`.
- `/design/` shows `0.9.7.5.38` in the top bar.
- responses under `/design/` include `X-Forma-Version: 0.9.7.5.38` and `Cache-Control: no-store`.
...
## Chart responsive resize — v0.9.7.5.38
...
## v0.9.7.5.38 — Layout, palette themes, fill/stroke and export chooser
...
## Shared library + Projects — v0.9.7.5.38
...
## Clipboard e agrupamento — v0.9.7.5.38
...
## Rich text + alinhamento — v0.9.7.5.38
...
## Clipboard + planilha de colagem — v0.9.7.5.38
...
## Planilha — cabeçalho obrigatório na primeira linha (v0.9.7.5.38)
...
## Video fidelity lock — v0.9.7.5.38
...
## Board video fidelity — v0.9.7.5.38
