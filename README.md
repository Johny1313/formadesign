...
## Deploy verification — v0.9.7.5.46

After `npm install` and `npm run deploy`, verify:

- `/api/health` returns `version: 0.9.7.5.46`.
- `/design/` shows `0.9.7.5.46` in the top bar.
- responses under `/design/` include `X-Forma-Version: 0.9.7.5.46` and `Cache-Control: no-store`.
...
## Chart responsive resize — v0.9.7.5.46
...
## v0.9.7.5.46 — Layout, palette themes, fill/stroke and export chooser
...
## Shared library + Projects — v0.9.7.5.46
...
## Clipboard e agrupamento — v0.9.7.5.46
...
## Rich text + alinhamento — v0.9.7.5.46
...
## Clipboard + planilha de colagem — v0.9.7.5.46
...
## Planilha — cabeçalho obrigatório na primeira linha (v0.9.7.5.46)
...
## Video fidelity lock — v0.9.7.5.46
...
## Board video fidelity — v0.9.7.5.46
...
## Hub editorial de imagens — atualização escalonada 0.9.7.5.41 → 0.9.7.5.46
...
### 0.9.7.5.46 — Fluxo final factual → banco → IA
