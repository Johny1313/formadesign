...
## Deploy verification — v0.9.7.5.47

After `npm install` and `npm run deploy`, verify:

- `/api/health` returns `version: 0.9.7.5.47`.
- `/design/` shows `0.9.7.5.47` in the top bar.
- responses under `/design/` include `X-Forma-Version: 0.9.7.5.47` and `Cache-Control: no-store`.
...
## Chart responsive resize — v0.9.7.5.47
...
## v0.9.7.5.47 — Layout, palette themes, fill/stroke and export chooser
...
## Shared library + Projects — v0.9.7.5.47
...
## Clipboard e agrupamento — v0.9.7.5.47
...
## Rich text + alinhamento — v0.9.7.5.47
...
## Clipboard + planilha de colagem — v0.9.7.5.47
...
## Planilha — cabeçalho obrigatório na primeira linha (v0.9.7.5.47)
...
## Video fidelity lock — v0.9.7.5.47
...
## Board video fidelity — v0.9.7.5.47
...
## Hub editorial de imagens — atualização escalonada 0.9.7.5.41 → 0.9.7.5.47
...
### 0.9.7.5.47 — Fluxo final factual → banco → IA
